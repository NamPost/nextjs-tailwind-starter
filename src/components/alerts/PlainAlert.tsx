              ...
              <div className="p-4">
                <div className="flex items-center">
                  <div className="flex w-0 flex-1 justify-between">
                    <p className="w-0 flex-1 text-sm font-medium text-gray-900  dark:text-gray-50">This is a SnackBar Message</p>
                    <button
                      type="button"
                      className="ml-3 flex-shrink-0 rounded-md bg-white dark:bg-darklight  text-sm font-medium text-primary hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                    >
                      Undo
                    </button>
                  </div>
